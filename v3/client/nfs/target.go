...
import (
	...
	"github.com/zperf/nfs/v3/client/nfs/util"
	"github.com/zperf/nfs/v3/client/nfs/xdr"
)
...
func NewTargetWithPort(addr string, port int, auth rpc.Auth, fh []byte, dirpath string) (*Target, error) {
	client, err := DialServiceWithPort(addr, port)
	if err != nil {
		return nil, err
	}
